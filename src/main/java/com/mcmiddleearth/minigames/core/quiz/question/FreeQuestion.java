...
public class FreeQuestion extends AbstractQuestion{
    ...
    private static final char[][] charReplacement =  new char[][]{{'a','\u00E0','\u00E1','\u00E2','\u00E3','\u00E4','\u00E5'},
            {'e','\u00E8','\u00E9','\u00EA','\u00EB','\u0113','\u011B'},
            {'i','\u00EC','\u00ED','\u00EE','\u00EF','\u0129','\u012B'},
            {'o','\u00F2','\u00F3','\u00F4','\u00F5','\u00F6','\u014D'},
            {'u','\u00F9','\u00FA','\u00FB','\u00FC','\u0169','\u016B'},
    ...
    public Message[] getDetails() {
        return new Message[]{MiniGames.message("[Type]", Style.HIGHLIGHT).add(" FREE answer question",Style.HIGHLIGHT_STRESSED),
