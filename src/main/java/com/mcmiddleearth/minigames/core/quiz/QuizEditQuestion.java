...
public class QuizEditQuestion {
    ...
    private static final List<McmeProxyPlayer> inEditConversation = new ArrayList<>();
    private static final HashMap<McmeProxyPlayer,QuizEditQuestion> editSave = new HashMap<>();
    ...
    public QuizEditQuestion(McmeProxyPlayer player,int index){
        ...
        if(game != null){
            ...
            player.sendMessage(MiniGames.message("[Question] "+question.getQuestion(), Style.QUESTION));
        }
    }
    ...
    public static QuizEditQuestion getEditInstance(McmeProxyPlayer player){
