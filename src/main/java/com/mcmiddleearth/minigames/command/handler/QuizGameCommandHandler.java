        ...
        switch (command){
            ...
            case "stat":
                ...
                if(quizgame.allAnswered()){
                    ...
                    PluginData.getMessageUtil().sendInfoMessage(sender, String.valueOf(quizgame.getPlayers().stream().map(Player::getUsername).collect(Collectors.toSet())));
                }else{
                    PluginData.getMessageUtil().sendInfoMessage(sender, "Players in question conversation:");
                    PluginData.getMessageUtil().sendInfoMessage(sender, String.valueOf(quizgame.getConversationPlayers().stream().map(Player::getUsername).collect(Collectors.toSet())));
                }
                break;
            case "submitquestion":
