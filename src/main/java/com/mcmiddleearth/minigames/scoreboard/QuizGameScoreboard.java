...
import com.mcmiddleearth.minigames.scoreboard.generics.CRUD;
...
//        quizObjective.setAction(CRUD.CREATE);
...
//        timerObjective.setAction(CRUD.CREATE);
//        timerObjective.setValue(Component.text("Question "+currentQuestion+" / " + questionCount));
...
//        updateQuiz();
//        quizObjective.setValue(Component.text("Question "+currentQuestion+" / " + questionCount));
